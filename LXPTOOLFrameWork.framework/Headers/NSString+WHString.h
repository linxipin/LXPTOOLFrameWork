...
/**
 ...
 @return 目标字符串
 */
- (NSString*)lxp_substringWithinBoundsLeft:(NSString*)strLeft right:(NSString*)strRight;
...
/**
 ...
 @return 返回的中文数字
 */
+(NSString *)lxp_translation:(NSString *)arebic;
...
/**
 ...
 @return 反转之后的字符串
 */
- (NSString*)lxp_reverseWordsInString:(NSString*)str;
...
/**
 ...
 @return 拼音
 */
+ (NSString *)lxp_transform:(NSString *)chinese;
